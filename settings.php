            ...
            if (
                ...
                if ($stmt) {
                    ...
                    if ($stmt->execute()) {
                        ...
                        $error = "Unable to update your account settings.";
                    }
                ...
                if ($stmt) {
                    ...
                    if ($stmt->execute()) {
                        ...
                        $error = "Unable to update your account information.";
                    }
...
<title>
    Settings | Food Process Practical Learning System
</title>
...
<aside class="sidebar">
    ...
    <a
        href="dashboard.php#profileModal"
        class="nav-link-custom"
    >
    ...
    <a
        href="dashboard.php#emergencyModal"
        class="nav-link-custom"
    >
    ...
    <a
        href="dashboard.php#safetyModal"
        class="nav-link-custom"
    >
    ...
    <a
        href="dashboard.php#programmeModal"
        class="nav-link-custom"
    >
