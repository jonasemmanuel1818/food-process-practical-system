...
if ($activity_number < 1 || $activity_number > 12) {
    echo json_encode([
        "success" => false,
        "message" => "Invalid Practical 4 activity number."
    ]);
    exit();
}
...
if ($stmt->execute()) {
    ...
    echo json_encode([
        "success" => true,
        "message" => "Practical 4 activity progress saved."
    ]);
    ...
    echo json_encode([
        "success" => false,
        "message" => "Could not save Practical 4 activity progress."
    ]);
}
